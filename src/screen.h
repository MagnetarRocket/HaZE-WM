...
typedef struct ScreenInfo
{
	...
	Window lbCorner;
	Window rbCorner;
	HAZEWMWindow *ActiveWin;
	HAZEWMWindow **LastActive;
	HAZEWMWindow *PreviousActive;
	ShortCut *ShortCutRoot;
	int root_pushes;
	HAZEWMWindow *pushed_window;
	Cursor HAZEWMCursors[MAX_CURSORS];
	styles *style_list;
	GC RobberGC;
	GC BlackGC;
	GC WhiteGC;
	...
	GC TitleActiveFGGC;
	GC TitleActiveBGGC;
	GC TitleInActiveFGGC;
	GC TitleInActiveBGGC;
	GC DecorationsActiveFGGC;
	GC DecorationsActiveBGGC;
	GC DecorationsInActiveFGGC;
	GC DecorationsInActiveBGGC;
