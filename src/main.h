...
typedef struct HAZEWMWindow
{
	struct HAZEWMWindow *next;
	struct HAZEWMWindow *prev;
	Window w;
	Window frame;
	Window Parent;
	Window title_w;
...
#define NORMALWIN		(TITLE | RESIZER | CLOSER | MINMAXR)
